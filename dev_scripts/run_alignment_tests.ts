...
import {CatBoostWordMap, MorphCatBoostWordMap} from "./boostwordmap_tools";
...
//this is like the previous test but takes word morphology into consideration.
function run_morph_catboost_test_with_alignment_adding_method( number_suffix: string, alignment_adder: (source_text: {[key: string]: Token[]}, target_text: {[key: string]: Token[]}, alignments: {[key: string]: Alignment[] }) => Promise<void>){
    const loaded_alignment = recursive_json_load( "/home/lansford/translationCore/projects/en_ult_mat_book/.apps/translationCore/alignmentData/mat")
    ...
    alignment_adder.call( boostMap, converted_mat_greek, converted_mat_lte_c14, train_alignment ).then(() => {
        ...
        const output_csv = createWriteStream( `dev_scripts/data/mat_split_morph_catboost_${number_suffix}.csv` );
...
function run_catboost_wordmap_test_1(){
    run_catboost_test_with_alignment_adding_method( "1", CatBoostWordMap.prototype.add_alignments_1 );
}



function run_catboost_wordmap_test_2(){
    run_catboost_test_with_alignment_adding_method( "2", CatBoostWordMap.prototype.add_alignments_2 );
}

//This uses catboost but gathers the statistics
//with the alignments added first.
function run_catboost_wordmap_test_3(){    
    run_catboost_test_with_alignment_adding_method( "3", CatBoostWordMap.prototype.add_alignments_3 );
}


function run_catboost_wordmap_test_4(){
    run_catboost_test_with_alignment_adding_method( "4", CatBoostWordMap.prototype.add_alignments_4 );
}
...
function run_morph_catboost_wordmap_test_1(){
    run_morph_catboost_test_with_alignment_adding_method( "1", MorphCatBoostWordMap.prototype.add_alignments_1 );
}
function run_morph_catboost_wordmap_test_2(){
    run_morph_catboost_test_with_alignment_adding_method( "2", MorphCatBoostWordMap.prototype.add_alignments_2 );
}
function run_morph_catboost_wordmap_test_3(){
    run_morph_catboost_test_with_alignment_adding_method( "3", MorphCatBoostWordMap.prototype.add_alignments_3 );
}
function run_morph_catboost_wordmap_test_4(){
    run_morph_catboost_test_with_alignment_adding_method( "4", MorphCatBoostWordMap.prototype.add_alignments_4 );
}
