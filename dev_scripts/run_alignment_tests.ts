...
//     boostMap.add_alignments_1( converted_mat_greek, converted_mat_lte_c14, train_alignment ).then(() => {

//         const output_csv = createWriteStream( "dev_scripts/data/mat_split_catboost_1.csv" );
...
function run_catboost_wordmap_test_3(){
    ...
    boostMap.add_alignments_3( converted_mat_greek, converted_mat_lte_c14, train_alignment ).then(() => {

        const output_csv = createWriteStream( "dev_scripts/data/mat_split_catboost_3.csv" );
